...
@Component
public class InsertProductAdmin {
	...
	private int product_rating;
	 public InsertProductAdmin() {
			this("","","","",0.0,"",0,0);
		}
	public InsertProductAdmin(String product_name, String product_brand,
	...
	public String toString() {
		return "InsertProductAdmin [product_id=" + product_id
				+ ", product_name=" + product_name + ", product_brand="
				+ product_brand + ", product_description="
				+ product_description + ", product_image=" + product_image
